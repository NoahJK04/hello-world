function x0 = initial_state_psa(par)
%INITIAL_STATE_PSA Build initial state vector for PSA model.
...
if par.use_iast
    ...
    wO2_star = isotherm_sips(T0, yO2_0*P0*par.u.Pa_to_bar, par.iso.O2);
    wN2_star = isotherm_sips(T0, (1-yO2_0)*P0*par.u.Pa_to_bar, par.iso.N2);
end
